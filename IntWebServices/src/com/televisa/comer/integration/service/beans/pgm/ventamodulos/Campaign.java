 ...
 *         &lt;element name="Channel" type="{http://com/televisa/comer/integration/service/beans/pgm/ventamodulos}Channel" maxOccurs="unbounded"/>
 *         &lt;element name="Spot" type="{http://com/televisa/comer/integration/service/beans/pgm/ventamodulos}Spot" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Campaign", propOrder = {
         "action", "orderID", "agencyID", "advertirserID", "initialDate", "endDate", "masterContract", "rateCard",
         "targetID", "channel", "spot"
    })
